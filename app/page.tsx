  ...
  return (
    <main className="w-full">
      ...
      <section className="px-8 py-12 space-y-6 bg-white">
        <h2 className="text-[#292673] text-[18px] font-semibold">O que fazemos</h2>

        <p className="text-[15px] leading-6">
          Transformamos os <strong>processos internos</strong> e a{" "}
          <strong>experiência dos clientes</strong> com clareza, método e acompanhamento real.
        </p>

        <p className="text-[15px] leading-6">
          Enquanto você dirige, a NexCX lê o painel, aponta riscos e ajusta o trajeto.
        </p>
      </section>
          ...
          {services.map((item, idx) => {
            ...
            return (
              <div key={item.title} className="bg-white rounded-2xl overflow-hidden">
                ...
                >
                  <span className="text-[#292673] font-semibold text-[15px]">{item.title}</span>

                  <span className={`shrink-0 transition-transform ${isOpen ? "rotate-180" : "rotate-0"}`} aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#292673]">
      ...
      <section id="contato" className="px-8 py-12 space-y-6 bg-white">
        <div className="flex items-center">
          <img src="/imagens/Logo.png" alt="NexCX" className="h-8 w-auto" draggable={false} />
        </div>

        <div className="space-y-3">
          <a href="#" className="block rounded-2xl border border-[#292673]/20 px-4 py-3 text-[#292673] font-medium">
            WhatsApp
          </a>
          <a href="#" className="block rounded-2xl border border-[#292673]/20 px-4 py-3 text-[#292673] font-medium">
            E-mail
